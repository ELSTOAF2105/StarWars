public class StormTrooper extends Combatant implements SpecialAttack {
    ...
    public StormTrooper(String n) {
        super(n, STARTING_HEALTH);
    }

    public StormTrooper(String n, int h) {
        super(n, h);
    }
    ...
    public int getSpecialAttackPower() {
     ...
     public String getSpecialAttackMessage(Combatant defender) {
        String msg = "";
        msg += this.getName() + " strikes " + defender.getName() + " with a SPECIAL ATTACK!!!";
        return msg;
     }
